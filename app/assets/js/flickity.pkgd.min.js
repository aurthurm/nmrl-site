...
(function (t, e) {
  ...
  var n = ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "marginLeft", "marginRight", "marginTop", "marginBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"];
  var s = n.length;
  ...
  function c(e) {
    ...
    var c = a.isBorderBox = i.boxSizing == "border-box";
    ...
    var b = a.borderLeftWidth + a.borderRightWidth;
  ...
  i.htmlInit = function (e, n) {
    i.docReady(function () {
      ...
      h.forEach(function (t) {
        var i = t.getAttribute(o) || t.getAttribute(c);
        var r;
...
(function (t, e) {
  if (typeof define == "function" && define.amd) {
    define("flickity/js/flickity", ["ev-emitter/ev-emitter", "get-size/get-size", "fizzy-ui-utils/utils", "./cell", "./slide", "./animate"], function (i, n, s, r, o, a) {
  ...
  p._wrapSelect = function (t) {
    ...
    var s = n.modulo(t, e);
    var r = Math.abs(s - this.selectedIndex);
    var o = Math.abs(s + e - this.selectedIndex);
  ...
  p.watchCSS = function () {
    ...
    var e = l(this.element, ":after").content;
...
(function (t, e) {
  ...
  function s(t) {
    if (t.nodeName == "IMG") {
      ...
      var n = t.getAttribute("data-flickity-lazyload-src");
      var s = t.getAttribute("data-flickity-lazyload-srcset");
...
(function (t, e) {
  ...
  i.navCompanionSelect = function (t) {
    ...
    var i = e[0];
    var s = this.navCompanion.cells.indexOf(i);
    var r = s + e.length - 1;
    var o = Math.floor(n(s, r, this.navCompanion.cellAlign));
